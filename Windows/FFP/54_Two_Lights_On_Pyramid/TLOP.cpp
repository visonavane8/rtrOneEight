...
void drawPyramid()
{
	...
	glVertex3f(-1.0f, -1.0f, 1.0f); //LF
	glVertex3f(1.0f, -1.0f, 1.0f); //RF

	//RIGHT FACE
	glNormal3f(0.894427f, 0.447214f, 0.0f);
	glVertex3f(0.0f, 1.0f, 0.0f); //apex
	glVertex3f(1.0f, -1.0f, 1.0f); //LR
	glVertex3f(1.0f, -1.0f, -1.0f); //RR
	...
	glNormal3f(-0.894427f, 0.447214f, 0.0f);
	glVertex3f(0.0f, 1.0f, 0.0f); //Apex
	glVertex3f(-1.0f, -1.0f, -1.0f); //LL
	glVertex3f(-1.0f, -1.0f, 1.0f);  //RL
